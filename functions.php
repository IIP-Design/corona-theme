...
function corona_scripts() {
	wp_enqueue_style( 'corona-style', get_stylesheet_uri(), array(), '1.5.0', 'all' );
	wp_enqueue_script( 'corona-js', get_template_directory_uri() . '/js/dist/script.js', array(), '1.5.0', true );
